...
function ContactsDetails() {
  ...
  return !isEmpty(selectedContact) ? (
    <Container>
      <LeftContainer>
        ...
        <Box>
          ...
          <TextInputWrapper
            ...
            value={findPrimaryEmail(selectedContact?.emailAddress) || ""}
            radius="md"
            disabled
          />
          <TextInputWrapper
            ...
            radius="md"
            value={findPrimaryPhoneNumIntl(selectedContact?.phoneNumber) || ""}
            disabled
          />
          <TextInputWrapper
            label="LinkedIn"
      ...
      <MiddleContainer>
        ...
        >
          ...
          <Tabs.Panel value="notes">
            ...
            >
              <Note
                resourceId={selectedContact.contactId}
